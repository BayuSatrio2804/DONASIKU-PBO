            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className={`py-3 px-2 text-sm md:text-base rounded-xl font-semibold transition-all duration-200 ${formData.role === 'donatur'
                ...
                <button
                  ...
                  className={`py-3 px-2 text-sm md:text-base rounded-xl font-semibold transition-all duration-200 ${formData.role === 'penerima'
                    ? 'bg-gradient-to-r from-[#007EFF] to-[#0063FF] text-white shadow-lg scale-105'
                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                >
                ...
                <button
                  ...
                  className={`py-3 px-2 text-sm md:text-base rounded-xl font-semibold transition-all duration-200 ${formData.role === 'admin'
                    ? 'bg-gradient-to-r from-[#007EFF] to-[#0063FF] text-white shadow-lg scale-105'
                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                >
