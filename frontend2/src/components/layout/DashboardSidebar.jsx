...
import {
  ...
  FiLogOut, FiChevronLeft, FiSearch, FiHeart, FiUserCheck, FiUsers
} from 'react-icons/fi';
...
const DashboardSidebar = ({ isOpen, toggleSidebar }) => {
  ...
  if (role === 'donatur') {
    ...
    mainMenuItems = [
      ...
      { path: '/admin/verifikasi-penerima', label: 'Verif Penerima', icon: FiUserCheck },
      { path: '/admin/users', label: 'Kelola User', icon: FiUsers },
    ];
    bottomMenuItems = [
      { path: '/admin/profil', label: 'Profil Admin', icon: FiUser },
    ];
  }
